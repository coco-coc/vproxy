  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: BlocSelector<OutboundBloc, OutboundState,
            ({NodeGroup? selected, List<NodeGroup> groups})>(selector: (state) {
            ...
            return DropdownMenu<NodeGroup>(
              ...
              dropdownMenuEntries: [allGroup, ...r.groups].map((e) {
                return DropdownMenuEntry(
                    value: e, label: groupNametoLocalizedName(context, e.name));
              }).toList(),
              onSelected: (value) =>
                  ctx.read<OutboundBloc>().add(SelectedGroupChangeEvent(value)),
            );
          }
                  ...
                  child: MenuAnchor(
                    ...
                    child: FilterChip(
                        visualDensity: (Platform.isAndroid || Platform.isIOS)
                            ...
                            : null,
                        label: Text(groupNametoLocalizedName(context, e.name)),
                        selected: r.selected?.name == e.name,
                        onSelected: (bool v) {
                          print('onSelected: $v');
                          ctx
                              .read<OutboundBloc>()
                              .add(SelectedGroupChangeEvent(v ? e : null));
                        }),
                  ),
                );
              }).toList(),
