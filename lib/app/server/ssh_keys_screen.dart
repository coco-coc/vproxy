        ...
        children: [
          FilledButton.tonalIcon(
            onPressed: () async {
              ...
              if (fullScreen) {
                form = await Navigator.of(context, rootNavigator: true)
              ...
              try {
                final k =
                    await database.into(database.commonSshKeys).insertReturning(
                ...
                await storage.write(
                    key: sssName, value: jsonEncode(sss.toJson()));
