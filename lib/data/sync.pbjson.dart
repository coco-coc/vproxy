...
const SyncOperation$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.vx.ServerOperation',
      '9': 0,
      '10': 'serverOperation'
    },
    {
      '1': 'common_ssh_key_operation',
      '3': 14,
      '4': 1,
      '5': 11,
      '6': '.vx.CommonSshKeyOperation',
      '9': 0,
      '10': 'commonSshKeyOperation'
    },
  ],
  '8': [
    {'1': 'type'},
...
final $typed_data.Uint8List syncOperationDescriptor = $convert.base64Decode(
    'Cg1TeW5jT3BlcmF0aW9uEhIKBHRpbWUYASABKARSBHRpbWUSKwoJc3FsX3F1ZXJ5GAogASgLMg'
    'wudnguU3FsUXVlcnlIAFIIc3FsUXVlcnkSMQoLYWRkX2hhbmRsZXIYCyABKAsyDi52eC5BZGRI'
    'YW5kbGVySABSCmFkZEhhbmRsZXISNwoNc3FsX29wZXJhdGlvbhgMIAEoCzIQLnZ4LlNxbE9wZX'
    'JhdGlvbkgAUgxzcWxPcGVyYXRpb24SQAoQc2VydmVyX29wZXJhdGlvbhgNIAEoCzITLnZ4LlNl'
    'cnZlck9wZXJhdGlvbkgAUg9zZXJ2ZXJPcGVyYXRpb24SVAoYY29tbW9uX3NzaF9rZXlfb3Blcm'
    'F0aW9uGA4gASgLMhkudnguQ29tbW9uU3NoS2V5T3BlcmF0aW9uSABSFWNvbW1vblNzaEtleU9w'
    'ZXJhdGlvbkIGCgR0eXBl');
...
final $typed_data.Uint8List syncOperationsDescriptor = $convert.base64Decode(
    'Cg5TeW5jT3BlcmF0aW9ucxIxCgpvcGVyYXRpb25zGAEgAygLMhEudnguU3luY09wZXJhdGlvbl'
    'IKb3BlcmF0aW9ucw==');
...
final $typed_data.Uint8List deleteHandlerDescriptor = $convert
    .base64Decode('Cg1EZWxldGVIYW5kbGVyEhgKB2hhbmRsZXIYASABKAxSB2hhbmRsZXI=');
...
final $typed_data.Uint8List deleteSubscriptionDescriptor = $convert
    .base64Decode('ChJEZWxldGVTdWJzY3JpcHRpb24SEAoDdXJsGAEgASgJUgN1cmw=');
...
final $typed_data.Uint8List serverOperationDescriptor = $convert.base64Decode(
    'Cg9TZXJ2ZXJPcGVyYXRpb24SLAoEdHlwZRgBIAEoDjIYLnZ4LlNlcnZlck9wZXJhdGlvbi5UeX'
    'BlUgR0eXBlEhAKA3JvdxgCIAEoCVIDcm93Eh8KC3N0b3JhZ2Vfa2V5GAMgASgJUgpzdG9yYWdl'
    'S2V5EiUKDnNlY3VyZV9zdG9yYWdlGAQgASgJUg1zZWN1cmVTdG9yYWdlEg4KAmlkGAUgASgDUg'
    'JpZCInCgRUeXBlEgcKA0FERBAAEgoKBlVQREFURRABEgoKBkRFTEVURRAC');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.vx.CommonSshKeyOperation.Type',
      '10': 'type'
    },
    {'1': 'row', '3': 2, '4': 1, '5': 9, '10': 'row'},
    {'1': 'storage_key', '3': 3, '4': 1, '5': 9, '10': 'storageKey'},
...
final $typed_data.Uint8List commonSshKeyOperationDescriptor = $convert.base64Decode(
    'ChVDb21tb25Tc2hLZXlPcGVyYXRpb24SMgoEdHlwZRgBIAEoDjIeLnZ4LkNvbW1vblNzaEtleU'
    '9wZXJhdGlvbi5UeXBlUgR0eXBlEhAKA3JvdxgCIAEoCVIDcm93Eh8KC3N0b3JhZ2Vfa2V5GAMg'
    'ASgJUgpzdG9yYWdlS2V5EiUKDnNlY3VyZV9zdG9yYWdlGAQgASgJUg1zZWN1cmVTdG9yYWdlEg'
    '4KAmlkGAUgASgDUgJpZCIbCgRUeXBlEgcKA0FERBAAEgoKBkRFTEVURRAB');
...
final $typed_data.Uint8List sqlOperationDescriptor = $convert.base64Decode(
    'CgxTcWxPcGVyYXRpb24SHwoEdHlwZRgBIAEoDjILLnZ4LlNRTFR5cGVSBHR5cGUSFAoFdGFibG'
    'UYAiABKAlSBXRhYmxlEhIKBHJvd3MYAyADKAlSBHJvd3MSEAoDaWRzGAQgAygDUgNpZHMSFAoF'
    'bmFtZXMYBSADKAlSBW5hbWVz');
...
final $typed_data.Uint8List sqlQueryDescriptor = $convert.base64Decode(
    'CghTcWxRdWVyeRIfCgR0eXBlGAEgASgOMgsudnguU1FMVHlwZVIEdHlwZRIcCglzdGF0ZW1lbn'
    'QYCiABKAlSCXN0YXRlbWVudBItCglhcmd1bWVudHMYCyADKAsyDy52eC5TcWxBcmd1bWVudFIJ'
    'YXJndW1lbnRz');
